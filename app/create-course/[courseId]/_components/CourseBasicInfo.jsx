...
function CourseBasicInfo({course,refreshData,edit=true}) {
  ...
  return (
    <div className='p-10 border shadow-xl rounded-xl mt-5 relative'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
            <div>
               ...
               {edit&& <EditCourseBasicInfo course={course} refreshData={()=>refreshData(true)} />} </h2>
                ...
                <h2 className='font-medium mt-2 flex gap-2 items-center text-blue-700'><HiOutlineRectangleStack />{course?.category}</h2>
