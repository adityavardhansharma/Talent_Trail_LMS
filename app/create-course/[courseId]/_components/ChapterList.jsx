    ...
    <div className='mt-3'>
        ...
        <div className='mt-2'>
            {course?.courseOutput?.course?.chapters.map((chapter,index)=>(
               <div className='border p-5 rounded-lg mb-2 flex items-center justify-between shadow-xl'>
                <div className='flex gap-5 items-center'>
                        ...
                        <div className=''>
                           ...
                           {edit&&  <EditChapters course={course} index={index} refreshData={refreshData} />} </h2>
                            ...
                            <p className='flex gap-2 text-blue-600 items-center'> <HiOutlineClock /> {chapter?.duration}</p>
