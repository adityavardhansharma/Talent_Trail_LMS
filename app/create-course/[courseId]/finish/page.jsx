...
function FinishScreen({params}) {
  ...
  return (
    <div className='px-10 md:px-20 lg:px-44 my-7'>
        <h2 className='text-center font-bold text-2xl my-3 bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent'>Congrats! Your course is Ready</h2>
       
       
        <CourseBasicInfo course={course} refreshData={()=>console.log()} />
       <h2 className='mt-3'>Course URL:</h2>
       <h2 className='text-center text-gray-400 hover:text-blue-600
